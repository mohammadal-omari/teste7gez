...
class Homepage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: Body(title: 'home page', mainWidget: ImgContainer()),
    );
  }
}
      ...
      Padding(
          ...
          child: Container(
              ...
              padding:  EdgeInsets.symmetric(horizontal: 15, vertical: 0.2),
                  ...
                  child:Text(
                  "This page describes how to download the Dart SDK. The Dart SDK has the libraries and command-line tools that you need to develop Dart command-line, server, and non-Flutter web apps. ",
